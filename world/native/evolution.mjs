// Generated from vendor/world-engine-v3.0.2/world-engine-evolution.js; source body is preserved verbatim after CRLF to LF normalization.
export function installNativeEvolution(window, SillyTavern, console) {
...
- 判断是否为同一对象只看 id。当前状态中不存在的 id 无效。`;
  ...
  return window.WORLD_ENGINE_EVOLUTION;
}
