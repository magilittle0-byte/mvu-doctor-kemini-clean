// Generated from vendor/world-engine-v3.0.2/world-engine-core.js; source body is preserved verbatim after CRLF to LF normalization.
export function installNativeCore(window, SillyTavern, console) {
  ...
  return window.WORLD_ENGINE_CORE;
}
