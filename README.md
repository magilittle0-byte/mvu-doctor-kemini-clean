...
当前安装：变量 **0.10.30**、人物档案 **0.1.0-candidate.4**、世界 **0.1.0-candidate.2**。三个模块按运行链和修复机制标准冻结，正常医生最多 **4次调用**，无自动重试。完整人物档案由医生根据正文、MVU和设定生成并填表，无需预设专用档案输出。

同一聊天12普通回合加1压力回合共99次（医生58，正文及其他41）。变量、档案、世界保存和刷新恢复有真实证据；世界公开结果尚未证明被正文采用，严格世界UI文本哈希比较存在已记录的字段顺序差异。**尚未完成完整真实语义门禁。** 版本、安装、费用及限制以[当前交付说明](docs/MODULAR_CURRENT_STATUS_2026-09-14.md)为准。
